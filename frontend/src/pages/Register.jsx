...
const Register = () => {
  ...
  const handleRegister = async (e) => {
    e.preventDefault();
    try {
      // Intentamos registrar al nuevo usuario (Por defecto creará un Técnico salvo que en backend cambiemos)
  ...
  return (
    <div className="flex-center" style={{ height: '100vh', flexDirection: 'column' }}>
      ...
      <div className="glass-panel animate-fade-in" style={{ width: '100%', maxWidth: '420px', textAlign: 'center' }}>
        <div style={{ marginBottom: '24px' }}>
          <UserPlus size={56} color="var(--accent-blue)" />
          <h2 style={{ marginTop: '12px', fontSize: '1.8rem' }}>Crear tu Cuenta</h2>
          <p style={{ color: 'var(--text-secondary)', fontSize: '0.9rem' }}>Únete a la red Refricop</p>
        </div>
